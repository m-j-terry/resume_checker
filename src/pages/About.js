...
export default function About(props) {
	return(
		<div className="AboutPage">
			...
			<h1>about me</h1>
			<div>
				<p>My name is Michael Terry. I am a software engineer and recent graduate of General Assembly's SEI Intensive Bootcamp. < br /> I am a former educator looking to break into the software engineering industry. I designed this application to help engineers like myself put their best foot forward on applications. </p>
